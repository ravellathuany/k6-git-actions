...
export default function(token) {
    ...
    const res = http.get(`${BASE_URL}/student/schedules`, params);
...
export function handleSummary(data) {
    return {
      "PT_01_stu_get_student_schedules_ufam.html": htmlReport(data),
      //"PT_01_stu_get_student_schedules_staging.html": htmlReport(data),
    };
}