...
export default function(token) {
    ...
    const res = http.get(`${BASE_URL}/teacher/2/subjects`, params);
...
export function handleSummary(data) {
    return {
      "PT_01_stu_get_teacher_id_subjects_ufam.html": htmlReport(data),
      //"PT_01_stu_get_teacher_id_subjects_staging.html": htmlReport(data),
    };
}