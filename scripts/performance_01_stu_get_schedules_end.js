...
export default function(token) {
    ...
    const res = http.get(`${BASE_URL}/schedules/ending`, params);
...
export function handleSummary(data) {
    return {
      //"PT_01_stu_get_schedules_end_ufam.html": htmlReport(data),
      "PT_01_stu_get_schedules_end_staging.html": htmlReport(data),
    };
}